...
function load() {
	...
	bar1.add("订单管理", "未付款订单", "<c:url value='/admin/AdminOrderServlet?method=findUnPay'/>", "body");
	bar1.add("订单管理", "已付款订单", "<c:url value='/admin/AdminOrderServlet?method=findPayed'/>", "body");
	bar1.add("订单管理", "未收货订单", "<c:url value='/admin/AdminOrderServlet?method=findUnReceive'/>", "body");
	bar1.add("订单管理", "已完成订单", "<c:url value='/admin/AdminOrderServlet?method=findReceived'/>", "body");
